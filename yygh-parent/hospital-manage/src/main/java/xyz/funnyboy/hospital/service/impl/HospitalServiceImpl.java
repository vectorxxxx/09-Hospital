...
import xyz.funnyboy.hospital.mapper.OrderInfoMapper;
import xyz.funnyboy.hospital.mapper.ScheduleMapper;
import xyz.funnyboy.hospital.model.OrderInfo;
import xyz.funnyboy.hospital.model.Patient;
import xyz.funnyboy.hospital.model.Schedule;
import xyz.funnyboy.hospital.service.HospitalService;
import xyz.funnyboy.hospital.util.ResultCodeEnum;
...
public class HospitalServiceImpl implements HospitalService
{
    ...
    public Map<String, Object> submitOrder(Map<String, Object> paramMap) {
        ...
        if (!schedule
                .getHoscode()
                .equals(hoscode) || !schedule
                .getDepcode()
                .equals(depcode) || !schedule
                .getAmount()
                .toString()
                .equals(amount)) {
            throw new YyghException(ResultCodeEnum.DATA_ERROR);
        ...
        if (availableNumber > 0) {
            ...
            String fetchTime = "0".equals(reserveDate) ?
                               " 09:30前" :
                               " 14:00前";
