      ...
      <div class="personal-patient">
        ...
        <div>
          ...
          <div class="content-wrapper">
            <el-form ref="patient" :model="patient" :rules="validateRules" label-width="110px" label-position="left">
            ...
            <el-form :model="patient" label-width="110px" label-position="left">
              ...
              <el-form-item prop="contactsCertificatesNo" label="证件号码：">
                <el-input
                  ...
                  contacts-certificates-no="请输入联系人证件号码"
                  class="input v-input"/>
              </el-form-item>
...
export default {
      ...
      props: {
        ...
        async lazyLoad(node, resolve) {
          ...
          dictApi.findByParentId(level ? node.value : '86').then(response => {
            ...
            const provinceList = list.map((item, i) => {
              return {
                value: item.id,
                label: item.name,
  ...
  methods: {
    ...
    saveData() {
      ...
      this.submitBnt = '正在提交...'
      patientApi.save(this.patient).then(() => {
    ...
    updateData() {
      ...
      this.submitBnt = '正在提交...'
      patientApi.updateById(this.patient).then(() => {
        this.$message.success('提交成功')
        window.location.href = '/patient'
      }).catch(() => {
        this.submitBnt = '保存'
